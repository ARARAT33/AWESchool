...
const LOCALIZED_P2P: Record<AppLanguage, {
  ...
  hy: {
    anonymousP2pChats: "Անանուն P2P Զրույցներ",
    noStorageWarning: "Ոչ մի տվյալ չի պահվում: Ամբողջությամբ տեղային և անվտանգ:",
    myId: "Իմ ID՝",
    copyIdTooltip: "Պատճենել իմ P2P ID-ն",
    addPeerHeader: "Միացնել նոր զրուցակից",
    peerPlaceholder: "Տեղադրեք ընկերոջ ID-ն...",
    noActiveConnections: "Չկա ոչ մի ակտիվ կապ:",
    howToConnectInstructions: "Տեղադրեք Ձեր ընկերոջ ID-ն վերևում՝ սկսելու համար:",
    peerTitle: "Զրուցակից",
    peerDesc: "Անանուն WebRTC ուղիղ տեքստային կապ:",
    readyToChat: "Պատրաստ է զրույցի...",
    deleteChatTooltip: "Ջնջել զրույցը",
    disconnectConfirm: "Ցանկանու՞մ եք անջատել կապը և ջնջել այս անանուն զրույցի պատմությունը:",
    ownIdAlert: "Դուք չեք կարող միանալ Ձեր սեփական ID-ին:",
    disconnectBtn: "Անջատել կապը",
    connectionEstablished: "Կապը հաստատված է",
    connectionEstablishedDesc: "Գրեք որևէ բան ստորև՝ տեքստային հաղորդագրություն ուղարկելու համար: Զրույցը լիովին գաղտնագրված է:",
    writeMessage: "Գրել հաղորդագրություն...",
    welcomeTitle: "Անանուն P2P Զրույցի Սրահ",
    welcomeDesc: "Սա ապակենտրոնացված WebRTC զրույց է: Մուտքագրեք Ձեր ընկերոջ P2P ID-ն ձախ վահանակում կամ փոխանցեք Ձեր ID-ն նրանց՝ անմիջական, անվտանգ կապ հաստատելու համար:",
    howToStart: "Ինչպե՞ս սկսել",
    step1: (id) => `Փոխանցեք Ձեր ID-ն (${id}) Ձեր ընկերոջը:`,
    step2: "Կամ տեղադրեք Ձեր ընկերոջ ID-ն ձախ կողմում և սեղմեք «+» կոճակը:",
    step3: "Ամբողջ զրույցը տեղի է ունենում միայն Ձեր սարքերի միջև (E2E Text Chat):",
    me: "Ես",
    responseSimulation: "P2P պատասխան իմիտացիա",
    receivedMessage: (text) => `Ստացա Ձեր հաղորդագրությունը՝ "${text}"`,
    anonymousSender: "Անանուն"
  },
  en: {
